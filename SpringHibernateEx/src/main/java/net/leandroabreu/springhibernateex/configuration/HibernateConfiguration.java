package net.leandroabreu.springhibernateex.configuration;
...
@ComponentScan({ "net.leandroabreu.springhibernateex.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory
                .setPackagesToScan(new String[] { "net.leandroabreu.springhibernateex.model" });
